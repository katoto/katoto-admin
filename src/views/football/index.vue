  ...
  <div class="app-container">
      ...
      <div>
        <section class="clear">
          ...
          <div style="float: right">
            ...
            <el-select size="small" v-model="selfootball" placeholder="请选择">
              <el-option
            ...
            <el-input v-model="searchExpect" size="small" :placeholder="searchName" class="common-input"></el-input>
        ...
        <el-table
          ...
          <el-table-column
            ...
            width="120">
            <template slot-scope="scope">
              <el-button @click="scoreOption( scope.row )" type="primary" size="small">
                修改比分
              </el-button>
            </template>
          </el-table-column>
    ...
    <el-dialog title="注意！" :visible.sync="dialogTableVisible">
      <div>
        ...
        <el-input style="width:150px" type="number" placeholder="主队修正比分" v-model='score_Home'></el-input> : 
        <el-input style="width:150px" type="number" placeholder="客队修正比分" v-model='score_Away'></el-input>
      </div>
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogTableVisible = false">取 消</el-button>
        <el-button type="primary" @click="sureScoreFn">确 定</el-button>
      </div>
    </el-dialog>
